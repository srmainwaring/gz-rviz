...
void FrameManager::tf_callback(const tf2_msgs::msg::TFMessage::SharedPtr _msg)
{
  ...
  for (const auto& frame : frame_ids) {
    try {
      ...
      tfTree[tf.child_frame_id] = gz::math::Pose3d(
...
////////////////////////////////////////////////////////////////////////////////
bool FrameManager::getFramePose(const std::string & _frame, gz::math::Pose3d & _pose)
{
  std::lock_guard<std::mutex>(this->tf_mutex_);
...
////////////////////////////////////////////////////////////////////////////////
bool FrameManager::getParentPose(const std::string & _child, gz::math::Pose3d & _pose)
{
  std::lock_guard<std::mutex>(this->tf_mutex_);
