...
#ifndef GZ_RVIZ_COMMON__FRAME_MANAGER_HPP_
#define GZ_RVIZ_COMMON__FRAME_MANAGER_HPP_
...
public:
   ...
   */
  bool getFramePose(const std::string & _frame, gz::math::Pose3d & _pose);
   ...
   * @return Pose validity (true if pose is valid, else false)
   */
  bool getParentPose(const std::string & _child, gz::math::Pose3d & _pose);
...
private:
  ...
  std::unordered_map<std::string, gz::math::Pose3d> tfTree;
...
#endif  // GZ_RVIZ_COMMON__FRAME_MANAGER_HPP_
