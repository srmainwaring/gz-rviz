...
#ifndef GZ_RVIZ_RVIZ_HPP_
#define GZ_RVIZ_RVIZ_HPP_
...
public:
  ...
  /**
   * @brief Initialize Gazebo RViz ROS node and frame manager
   * @throws anything rclcpp::exceptions::throw_from_rcl_error can throw.
   */
  void init_ros();

  /**
   * @brief Returns Gazebo RViz ROS node
