...
#ifndef GZ_RVIZ_PLUGINS_LASERSCANDISPLAY_HPP_
#define GZ_RVIZ_PLUGINS_LASERSCANDISPLAY_HPP_
...
private:
  ...
  gz::rendering::LidarVisualPtr rootVisual;
  std::mutex lock;
...
#endif  // GZ_RVIZ_PLUGINS_LASERSCANDISPLAY_HPP_
