...
#ifndef GZ_RVIZ_PLUGINS_TFDISPLAY_HPP_
#define GZ_RVIZ_PLUGINS_TFDISPLAY_HPP_
...
private:
  gz::rendering::AxisVisualPtr axis;
  gz::rendering::RenderEngine * engine;
  gz::rendering::ScenePtr scene;
  gz::rendering::VisualPtr tfRootVisual;
  std::mutex lock;
  bool axesVisible;
  bool arrowsVisible;
  bool namesVisible;
...
#endif  // GZ_RVIZ_PLUGINS_TFDISPLAY_HPP_
