...
#ifndef GZ_RVIZ_PLUGINS_POSEDISPLAY_HPP_
#define GZ_RVIZ_PLUGINS_POSEDISPLAY_HPP_
...
struct ArrowVisualPrivate
{
  ...
  gz::rendering::ArrowVisualPtr visual;
  gz::rendering::MaterialPtr mat;
...
struct AxisVisualPrivate
{
  ...
  gz::rendering::AxisVisualPtr visual;
  float length = 1.0;
  float radius = 0.1;
...
private:
  ...
  gz::rendering::VisualPtr rootVisual;
  std::mutex lock;
...
#endif  // GZ_RVIZ_PLUGINS_POSEDISPLAY_HPP_
