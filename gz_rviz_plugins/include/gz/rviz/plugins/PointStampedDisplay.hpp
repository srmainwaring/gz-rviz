...
#ifndef GZ_RVIZ_PLUGINS_POINTSTAMPEDDISPLAY_HPP_
#define GZ_RVIZ_PLUGINS_POINTSTAMPEDDISPLAY_HPP_
...
private:
  ...
  std::deque<gz::rendering::VisualPtr> visuals;
  std::mutex lock;
...
#endif  // GZ_RVIZ_PLUGINS_POINTSTAMPEDDISPLAY_HPP_
